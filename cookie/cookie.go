...
func init() {
	...
	http.HandleFunc("/link", linkTemplate)
	http.HandleFunc("/message", messageTemplate)
	http.HandleFunc("/cookie", cookieTemplate)
    mytemp = template.Must(template.ParseFiles("form.html","link.html","message.html","cookie.html"))
}
